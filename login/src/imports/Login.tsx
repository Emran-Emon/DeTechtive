import svgPaths from "./svg-v2g0tk2get";
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.97)] relative size-full" data-name="login">
      ...
      <p className="absolute font-['Courier_Prime:Regular',sans-serif] h-[32px] leading-[normal] left-[126px] not-italic text-[0px] text-white top-[811px] w-[617px]">
        ...
        <span className="text-[24px] text-yellow-400">Register now</span>
      ...
      <p className="absolute font-['Courier_Prime:Regular',sans-serif] h-[32px] leading-[normal] left-[273px] not-italic text-[20px] text-black top-[715px] w-[289px]">Login to System</p>
      ...
      <p className="absolute font-['Courier_Prime:Italic',sans-serif] h-[40px] italic leading-[normal] left-[418px] text-[20px] text-yellow-400 top-[595px] w-[564px]">Forgot password?</p>
