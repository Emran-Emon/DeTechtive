import svgPaths from "./svg-ybyfdsgvvx";
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.97)] relative size-full" data-name="signup">
      ...
      <p className="absolute font-['Courier_Prime:Regular',sans-serif] h-[32px] leading-[normal] left-[763px] not-italic text-[0px] text-white top-[935px] w-[617px]">
        ...
        <span className="text-[24px] text-yellow-400">Login</span>
      ...
      <p className="absolute font-['Courier_Prime:Regular',sans-serif] h-[25px] leading-[normal] left-[863px] not-italic text-[20px] text-black top-[849px] w-[233px]">Create Account</p>
    </div>
  );
}